/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: 97c39a8a64faea45c33f9377c4508dac)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	RESET_RATE_LIMITER: RateLimit;
	ALLOWED_ORIGINS: "https://action-check-webmcp.vercel.app" | "http://127.0.0.1:5173,http://localhost:5173,http://127.0.0.1:4173,http://localhost:4173";
	CAPABILITY_TTL_SECONDS: "900";
	DEPLOYMENT_ID: "action-check-2026-09-01-r1" | "local-development";
	REFUND_RUNS: DurableObjectNamespace<import("./src/index").RefundRunState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RefundRunState";
	}
	interface ProductionEnv {
		RESET_RATE_LIMITER: RateLimit;
		ALLOWED_ORIGINS: "https://action-check-webmcp.vercel.app";
		CAPABILITY_TTL_SECONDS: "900";
		DEPLOYMENT_ID: "action-check-2026-09-01-r1";
		REFUND_RUNS: DurableObjectNamespace<import("./src/index").RefundRunState>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "CAPABILITY_TTL_SECONDS" | "DEPLOYMENT_ID">> {}
}
